Shader "Hidden/EdgeDetection2"
{
    Properties
    {
        ...
        _OpacityMask("Opacity Mask", Color) = (1, 1, 1, 1)
    }
    SubShader
    {
        // No culling or depth
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                return colBase + max(8 * colM - colT - colTR - colR - colBR - colB - colBL - colL - colTL, 0) * _OpacityMask;
            }
            ENDCG
        }
    }
